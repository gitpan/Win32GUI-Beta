...
$List1 = $W->AddListbox(-name => "List1",
                        ...
                        -tabstop => 1,
                        -group => 1,
                        -width => 100) or print_and_die("new Listbox");
...
$Add   = $W->AddButton(-text  => "Add >",
                       ...
                       -tabstop => 1,
                       -group => 1,
                       -name  => "Add") or print_and_die("new Button");
...
$Edit1 = $W->AddTextfield(-text => "ciao",
                          -name => "Edit1",
                          -left => 5,
                          -top  => 115,
                          -height => 20,
                          -style => WS_TABSTOP | WS_CHILD | WS_BORDER | WS_VISIBLE | ES_LEFT | DS_3DLOOK,
                          -width => 100) or print_and_die("new Textfield");

$Edit2 = $W->AddTextfield(-text => "ciao",
                          -name => "Edit2",
                          -left => 250,
                          -top  => 115,
                          -height => 20,
